...
var ConsolidatableValidator = (function(_IsConsolidatable) {
  ...
  function ConsolidatableValidator(name) {
    ...
    return possibleConstructorReturn(
      this,
      (ConsolidatableValidator.__proto__ ||
        Object.getPrototypeOf(ConsolidatableValidator)
      ).call(this, name)
    );
  }
...
var StringValidator = (function(_IsString) {
  ...
  function StringValidator(name) {
    ...
    return possibleConstructorReturn(
      this,
      (StringValidator.__proto__ || Object.getPrototypeOf(StringValidator)
      ).call(this, name)
    );
  }
...
var destination = new StringValidator("destination");
var source = new StringValidator("source");
var sources = new ConsolidatableValidator("sources");
